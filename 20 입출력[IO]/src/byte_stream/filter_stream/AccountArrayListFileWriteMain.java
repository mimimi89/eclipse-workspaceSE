...
public class AccountArrayListFileWriteMain {
	...
	public static void main(String[] args) throws IOException {
		...
		DataOutputStream accountListDos=
				new DataOutputStream(new FileOutputStream("accountList.dat"));
		...
		for (Account account : accountList) {
			...
			accountListDos.writeDouble(account.getIyul());
		}
		
		
		accountListDos.flush();
		accountListDos.close();
		System.out.println("-----account list write accountList.dat-----");
